  ...
  ),
  {
    variants: {
      variant: {
        ...
        destructive: cn(
          'bg-destructive active:bg-destructive/90 dark:bg-destructive/80 shadow-sm shadow-black/10',
          Platform.select({
            web: 'hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40',
          })
        ),
        outline: cn(
          'border-border bg-card active:bg-accent dark:bg-card dark:border-border/90 dark:active:bg-accent/70 border shadow-sm shadow-black/5',
          Platform.select({
        ...
        ghost: cn(
          'active:bg-accent/80 dark:active:bg-accent/70',
